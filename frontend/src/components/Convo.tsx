      ...
      <div className="h-full flex-1 flex flex-col justify-between">
        <div className="px-4 py-2 flex items-center justify-between bg-primecl">
          ...
          <div className="flex gap-8">
			<div className="hover:bg-slate-600 rounded-xl hover:py-1 flex items-center">
				<svg
        ...
        <div className="flex flex-col-reverse flex-1 bg-segundcl py-2 overflow-scroll">
          <Chatmsg
          ...
          />
		  <Chatmsg
            text="This is a very big message in order to now if it fits in, and it does ooooooh my gooooodness, he made it, its his second goal tonight, and he starves for more"
            time="04:20"
            className="flex font-light justify-between bg-quatrocl rounded-e-lg rounded-bl-lg my-1 mx-4 w-96"
          />
        </div>
        <div className="py-4 bg-primecl w-full flex items-center justify-center gap-8">
          ...
          <input
            ...
            className="bg-terserocl rounded-md p-2 px-4 w-5/6"
          ></input>
          <Audio />
        </div>
      </div>
